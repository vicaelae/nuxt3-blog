export default {
  ...
  githubName: "vicaelae",                                     // 必须修改，github账户名



  /** -------------------------------------------------以下可选修改----------------------------------------------------- */

  title: "vicaelae的博客",                                        // 网站标题
  nickName: "vicaelae",                                           // 昵称
  domain: "",                        // rss域名
  SEO_title: " - vicaelae blog",                              // 搜索引擎显示的标题
  SEO_description: "vicaelae的博客，书写值得书写的东西",               // description meta header
  SEO_keywords: "vicaelae's blog", // keywords meta header
